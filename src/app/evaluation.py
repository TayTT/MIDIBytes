...
def analyze(file):
    ...
    estimated_tempo = analyze_midi_file(file)['estimated_tempo']
    ...
    df = create_dataframe(os.path.splitext(os.path.basename(file))[0], estimated_tempo, pitch_range, velocity_range, ioi, durations, harmonic_chords, harmonic_notes)
    return df
    #print(df)
