...
def tse(tokens: List[int], tokenizer: MusicTokenizer) -> Tuple[float, float, float, float, float]:
...
def print_data(pitch_range, velocity_range, ioi, durations, harmonic_chords, harmonic_notes):
    ...
    print("Harmony in chords: ", harmonic_chords)
    print("Harmony in notes: ", harmonic_notes)
    
def create_dataframe(title, estimated_tempo, pitch_range, velocity_range, ioi, durations, harmonic_chords, harmonic_notes):
    data = {
        # "Metric": ["Title", "Estimated Tempo", "Pitch Range", "Velocity Range", "Harmonic Chords", "Harmonic Notes"],
        # "Value": [title, estimated_tempo, pitch_range, velocity_range, harmonic_chords, harmonic_notes]
        "Title": [title],
        "Estimated Tempo": [estimated_tempo],
        "Pitch Range": [pitch_range],
        "Velocity Range": [velocity_range],
        "Harmonic Chords": [harmonic_chords],
        "Harmonic Notes": [harmonic_notes]
    }
